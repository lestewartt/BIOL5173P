...
Output of this script is as follows: 
    ...
    -this folder contains:
        ...
        -summary stats for low, medium, and high rates of community infection in parameter set 6 (can be adjusted to other parameters)
        -file containing data for each simulation under parameter set 6 (can also be adjusted to other parameters)
...
#summary stats for low rate of community infection 
...
#summary stats for medium rate of community infection 
...
#summary stats for high rate of community infection 
